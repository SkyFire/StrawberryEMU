...
class AuraEffect
{
    ...
    public:
        ...
        int32 GetMiscValueB() const { return m_spellProto->GetEffectMiscValueB(SpellEffIndex(m_effIndex)); }
        int32 GetMiscValue() const { return  m_spellProto->GetEffectMiscValue(SpellEffIndex(m_effIndex)); }
        
        AuraType GetAuraType() const { return (AuraType)m_spellProto->GetEffectApplyAuraNameByIndex(SpellEffIndex(m_effIndex)); }
