...
void WaypointStore::UpdatePath(uint32 id)
{
    ...
    result = WorldDB.PQuery("SELECT point,position_x,position_y,position_z,move_flag,delay,action,action_chance FROM waypoint_data WHERE id = %u ORDER BY point", id);
