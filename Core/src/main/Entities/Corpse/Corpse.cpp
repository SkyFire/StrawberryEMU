...
void Corpse::SaveToDB()
{
    ...
    ss  << "INSERT INTO corpse (guid,player,position_x,position_y,position_z,orientation,map,displayId,itemCache,bytes1,bytes2,flags,dynFlags,time,corpse_type,instance,phaseMask) VALUES ("
        << GetGUIDLow() << ", "
...
bool Corpse::LoadFromDB(uint32 guid, Field *fields)
{
    ...
    //SELECT position_x, position_y, position_z, orientation, map, displayId, itemCache, bytes1, bytes2, flags, dynFlags, time, corpse_type, instance, phaseMask, guid, player FROM corpse WHERE corpse_type <> 0
    ...
    m_type = CorpseType(fields[12].GetUInt32());
    ...
    uint32 phaseMask   = fields[14].GetUInt8();
