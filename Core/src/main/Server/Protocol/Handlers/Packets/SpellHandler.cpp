...
void WorldSession::HandleCastSpellOpcode(WorldPacket& recvPacket)
{
    ...
    sLog->outDebug(LOG_FILTER_NETWORKIO, "WORLD: got cast spell packet, castCount: %u, spellId: %u, UNK: %u, castFlags: %u, data length = %u", castCount, spellId, unk, castFlags, (uint32)recvPacket.size());
