...
enum ServerOpcodes
{
    ...
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                    = 0xA0E0,    // 41184 - 4.0.6a 13623
    SMSG_TRANSFER_PENDING                                = 0x7BE0,    // 31712 - 4.0.6a 13623
    SMSG_TRANSFER_ABORTED                                = 0x2BE0,    // 11232 - 4.0.6a 13623
    SMSG_WHO                                             = 0xBE8C,    // 48780 - 4.0.6a 13623
    SMSG_WHOIS                                           = 0xB1A4,    // 45476 - 4.0.6a 13623
    SMSG_CONTACT_LIST                                    = 0x748C,    // 29836 - 4.0.6a 13623
    SMSG_FRIEND_STATUS                                   = 0xF68C,    // 63116 - 4.0.6a 13623
    SMSG_MONSTER_MOVE                                    = 0xF1A4,    // 61860 - 4.0.6a 13623
    SMSG_TUTORIAL_FLAGS                                  = 0x3384,    // 13188 - 4.0.6a 13623
    SMSG_EMOTE                                           = 0xEEA0,    // 61088 - 4.0.6a 13623
    SMSG_TEXT_EMOTE                                      = 0xBB8C,    // 48012 - 4.0.6a 13623
    SMSG_SET_PROFICIENCY                                 = 0xBBA8,    // 48040 - 4.0.6a 13623
    SMSG_ACTION_BUTTONS                                  = 0x2CCC,    // 11468 - 4.0.6a 13623
    SMSG_AI_REACTION                                     = 0x31CC,    // 12748 - 4.0.6a 13623
    SMSG_CLIENT_CONTROL_UPDATE                           = 0x3C84,    // 15492 - 4.0.6a 13623
    SMSG_FLIGHT_SPLINE_SYNC                              = 0xBFAC,    // 49068 - 4.0.6a 13623
    SMSG_SHOW_BANK                                       = 0x1B8,
    SMSG_NOTIFICATION                                    = 0xBC88,    // 48264 - 4.0.6a 13623
    SMSG_LOG_XPGAIN                                      = 0xB880,    // 47232 - 4.0.6a 13623
    SMSG_LEVELUP_INFO                                    = 0xB9C4,    // 47556 - 4.0.6a 13623
    SMSG_START_MIRROR_TIMER                              = 0xA68C,    // 42636 - 4.0.6a 13623
    SMSG_PAUSE_MIRROR_TIMER                              = 0x21EC,    // 8684  - 4.0.6a 13623
    SMSG_STOP_MIRROR_TIMER                               = 0xB4A8,    // 46248 - 4.0.6a 13623
    SMSG_PONG                                            = 0xB880,    // 47232 - 4.0.6a 13623
    ...
    SMSG_AREA_TRIGGER_MESSAGE                            = 0xE4AC,    // 58540 - 4.0.6a 13623
    SMSG_DURABILITY_DAMAGE_DEATH                         = 0x2BD,
    SMSG_PLAY_SOUND                                      = 0x2EA8,    // 11944 - 4.0.6a 13623
    ...
    SMSG_IGNORE_REQUIREMENTS_CHEAT                       = 0x7C84,    // 31876 - 4.0.6a 13623
    SMSG_CLEAR_TARGET                                    = 0xA7AC,    // 42924 - 4.0.6a 13623
    SMSG_CROSSED_INEBRIATION_THRESHOLD                   = 0xA580,    // 42368 - 4.0.6a 13623
    SMSG_COMPLAIN_RESULT                                 = 0x70CC,    // 28876 - 4.0.6a 13623
    SMSG_FEATURE_SYSTEM_STATUS                           = 0x3DAC,    // 15788 - 4.0.6a 13623
    SMSG_DEBUG_LIST_TARGETS                              = 0x3D9,
    SMSG_GOGOGO_OBSOLETE                                 = 0x3F5,
    SMSG_MIRRORIMAGE_DATA                                = 0xE2A4,    // 58020 - 4.0.6a 13623
    SMSG_FORCE_DISPLAY_UPDATE                            = 0x6788,    // 26504 - 4.0.6a 13623
    SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT                = 0x78E8,    // 30952 - 4.0.6a 13623
    SMSG_OVERRIDE_LIGHT                                  = 0x2388,    // 9096  - 4.0.6a 13623
    SMSG_SERVER_BUCK_DATA                                = 0x41D,
    SMSG_PROPOSE_LEVEL_GRANT                             = 0xB8C8,    // 47304 - 4.0.6a 13623
    SMSG_UPDATE_ACCOUNT_DATA_COMPLETE                    = 0xB1CC,    // 45516 - 4.0.6a 13623
    SMSG_SERVER_BUCK_DATA_START                          = 0x4A3,
    SMSG_CLIENTCACHE_VERSION                             = 0x2EC4,    // 11972 - 4.0.6a 13623
    SMSG_SET_PROJECTILE_POSITION                         = 0x2C84,    // 11396 - 4.0.6a 13623
