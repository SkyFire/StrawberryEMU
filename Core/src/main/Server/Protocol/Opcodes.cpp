...
void InitOpcodeTable()
{
    ...
    OPCODE( CMSG_SET_PRIMARY_TALENT_TREE,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetPrimaryTalentTree      );
    ...
    OPCODE( UMSG_UNKNOWN_1189,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1196,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1197,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1198,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1199,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1200,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1201,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( CMSG_LFG_SET_ROLES_2,                                 STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1209,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1219,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1220,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1221,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1222,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1225,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1226,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1227,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1228,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1239,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1243,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1244,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1245,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1257,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1258,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( MSG_SET_RAID_DIFFICULTY,                              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode   );
    OPCODE( UMSG_UNKNOWN_1260,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1266,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1267,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1268,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1269,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1273,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( SMSG_TALENTS_INVOLUNTARILY_RESET,                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE( UMSG_UNKNOWN_1275,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1278,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1283,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1284,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1285,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( SMSG_CORPSE_NOT_IN_INSTANCE,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE( UMSG_UNKNOWN_1287,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1292,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( UMSG_UNKNOWN_1299,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE( CMSG_UNKNOWN_27616,                                   STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( SMSG_UNKNOWN_1304,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE( UMSG_UNKNOWN_1305,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE( UMSG_UNKNOWN_1306,                                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
