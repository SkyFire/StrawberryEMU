...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "trinity_string",               SEC_ADMINISTRATOR, true,  &HandleReloadStringCommand,              "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadStringCommand(handler,"");
    ...
    static bool HandleReloadStringCommand(ChatHandler* handler, const char* /*args*/)
    {
