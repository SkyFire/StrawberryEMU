...
public:
    ...
    static bool HandleGameObjectAddCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (spawntimeSecs)
        {
            ...
            //sLog->OutDebug(LOG_FILTER_SSCR, "*** spawntimeSecs: %d", value);
        }
        ...
        sLog->outDebug(LOG_FILTER_CHATSYS, handler->GetString(LANG_GAMEOBJECT_CURRENT), gInfo->name, db_lowGUID, x, y, z, o);
