    ...
    public:
        ...
        struct instance_zulaman_InstanceMapScript : public InstanceScript
        {
            ...
            std::string GetSaveData()
            {
                ...
                //sLog->outError("SCR: Zul'aman saved, %s.", data);
                return data;
            }
            ...
            void Load(const char* load)
            {
                ...
                //sLog->outError("SCR: Zul'aman loaded, %s.", ss.str().c_str());
                char dataHead; // S
                uint16 data1, data2, data3;
                ss >> dataHead >> data1 >> data2 >> data3;
                //sLog->outError("SCR: Zul'aman loaded, %d %d %d.", data1, data2, data3);
                if (dataHead == 'S')
                {
                    BossKilled = data1;
                    ChestLooted = data2;
                    QuestMinute = data3;
                } else sLog->outError("SCR: Zul'aman: corrupted save data.");
            }
