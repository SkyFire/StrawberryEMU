...
bool Master::_StartDB()
{
    ...
    {
        sLog->outError("World database: invalid number of asynchron threads specified. "
    ...
    if (async_threads < 1 || async_threads > 32)
    {
        sLog->outError("Character database: invalid number of asynchron threads specified. "
            "Please pick a value between 1 and 32.");
        return false;
    }
